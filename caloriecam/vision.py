...
holds more than ~25% of the bowl's own volume, and food lifted on a utensil \
came FROM the bowl - never add rim-full volume plus a large dome plus a \
lifted portion as three separate amounts.
